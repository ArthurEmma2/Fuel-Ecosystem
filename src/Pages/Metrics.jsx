...
function Metrics() {
  return (
    ...
    <div className=''>
        ...
        <p className='text-[#90E6D1] opacity-70 text-5xl lg:text-5xl mt-6 font-extrabold tracking-[2px] w-full md:w-[750px] text-center lg:text-left'>Fuel Ecosystem cares about delivering all the ecosystem metrics</p>
